...
public static final String DOT = ".";
	...
	/* osgi system启动扩展包gate目录 */
	public static final String SYSTEM_EXT_GATE_DIR = "antelope.ci.bus.system.ext.gate.dir";
	public final static String SYSTEM_EXT_GATE_DIRNAME = "com.antelope.ci.bus.gate";
