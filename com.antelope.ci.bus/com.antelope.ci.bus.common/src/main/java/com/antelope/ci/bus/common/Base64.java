// com.antelope.ci.bus.common.Base64.java
/**
...
public class Base64 {
	...
	public static byte[] decode(byte[] message) throws CIBusException {
		...
		for (int i = 0; i < message.length; i++) {
			...
			if ((c >= 'A') && (c <= 'Z')) {
				...
				throw new CIBusException("", "Illegal char in base64 code.");
			}
			...
			if (bpos == 4) {
				...
				if (buff[1] == 64)
					throw new CIBusException("", "Unexpected '=' in base64 code.");
