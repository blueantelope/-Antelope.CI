 ...
 */
public class EngineServicePublisher {
	private static final Logger log = Logger.getLogger(EngineServicePublisher.class);
	private static Map<String, BusEngineService> serviceMap = new ConcurrentHashMap<String, BusEngineService>();
				...
				try {
					...
					for (String cls : classList) {
						...
						if (needReg) {
							...
							BusEngineService service = serviceMap.get(cls);
