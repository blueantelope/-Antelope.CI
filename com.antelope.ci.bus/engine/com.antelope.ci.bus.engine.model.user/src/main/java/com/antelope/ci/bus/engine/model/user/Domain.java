...
public class Domain {
	...
	public final static int BASETYPE_PORTAL_ID = 0;
	public final static int BASETYPE_PORTAL_SHELL_ID = 2;
	public final static int BASETYPE_GATE_ID = 10;
	public final static int BASETYPE_GATE_API_ID = 11;
	public final static int BASETYPE_GATE_SHELL_ID = 12;
	public final static int BASETYPE_APP_ID = 20;
	public final static int BASETYPE_APP_WEB_ID = 21;
	...
	public enum DOMAIN_BASETYPE {
		...
		APP_WEB(BASETYPE_APP_WEB_ID, "APP_WEB", BASETYPE_APP_ID);
