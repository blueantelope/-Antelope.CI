...
public class BusGateSshServer extends BusSshServer {
	...
	/**
	 * @Deprecated replace by {@link #BusGateSshServer(BusServerContext context)}
	 */
	@Deprecated
	...
	public BusGateSshServer(BusServerContext context) throws CIBusException {
		super(context);
	}
	...
	protected void attatchCondition(BusServerCondition server_condition)
			throws CIBusException {
		server_condition.setServerType(SERVER_TYPE.API);
	}
