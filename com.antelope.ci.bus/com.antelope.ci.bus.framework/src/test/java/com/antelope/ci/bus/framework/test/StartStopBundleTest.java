...
public class StartStopBundleTest extends TestCase {
	...
	public void testStartStopBundle() throws Exception {
		...
		System.out.println("bundle class : " + bundle.toString() + ", bunlde classloader : " + bundle.getClass().getClassLoader().toString());
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(StartStopBundleTest.class);
	}
}