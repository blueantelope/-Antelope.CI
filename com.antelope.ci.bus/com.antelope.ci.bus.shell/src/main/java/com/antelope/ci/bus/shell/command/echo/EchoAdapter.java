...
package com.antelope.ci.bus.shell.command.echo;
...
public abstract class EchoAdapter extends  CommandAdapter {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.command.CommandAdapter#init()
	 */
	@Override
	protected void init() {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.command.CommandAdapter#showCommands(com.antelope.ci.bus.shell.BusShell, java.lang.String, int)
	 */
	@Override
