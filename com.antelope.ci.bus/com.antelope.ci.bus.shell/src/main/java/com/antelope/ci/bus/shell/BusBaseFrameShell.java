...
import com.antelope.ci.bus.shell.buffer.BusHitBuffer;
import com.antelope.ci.bus.shell.buffer.ShellCommandArg;
import com.antelope.ci.bus.shell.buffer.ShellCursor;
...
public abstract class BusBaseFrameShell extends BusShell {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.BusShell#action(int)
	 */
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.BusShell#mainView()
	 */
	@Override
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.BusShell#userAction(int)
	 */
