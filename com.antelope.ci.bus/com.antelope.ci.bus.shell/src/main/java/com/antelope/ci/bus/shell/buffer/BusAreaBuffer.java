...
import com.antelope.ci.bus.shell.ShellUtil;
import com.antelope.ci.bus.shell.buffer.ShellArea.DIRECTION;
import com.antelope.ci.bus.shell.util.TerminalIO;
...
public abstract class BusAreaBuffer extends BusBuffer {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#backspace()
	 */
	@Override
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#delete()
	 */
	@Override
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#left()
	 */
	@Override
	public boolean left() {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#right()
	 */
	@Override
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#down()
	 */
	@Override
	public boolean down() {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#up()
	 */
	@Override
	public boolean up() {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#tab()
	 */
	@Override
	public void tab() {
		try {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#space()
	 */
	@Override
	public void space() {
		try {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#tabTip()
	 */
	@Override
	public void tabTip() {
		// nothing
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#printTips(java.util.List, int)
	 */
	@Override
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#exitSpace()
	 */
	@Override
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.antelope.ci.bus.shell.buffer.BusBuffer#put(char)
	 */
	@Override
